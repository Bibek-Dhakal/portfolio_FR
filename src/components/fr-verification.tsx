...
const FrVerification = () => {
    return (
        <a
            href="https://internship.flyrank.ai/verify?id=FR-D11-20CBF-CC2BF&first_name=Bibek"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Verify Bibek Dhakal's FlyRank AI Internship credential"
            style={{
        ...
        >
            ...
            >
                ...
                <path d="M7.9 12.3l2.8 2.8 5.4-5.8" stroke="#54E399" strokeWidth="1.8" strokeLinecap="round"
